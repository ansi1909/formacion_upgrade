...
begin
	...
	SELECT * FROM admin_sesion WHERE disponible = TRUE AND fecha_request IS NOT NULL AND fecha_request < (current_timestamp - interval '12 hours') ORDER BY id ASC LOOP
