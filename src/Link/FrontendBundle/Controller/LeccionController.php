        ...
        $html = '<div class="response d-flex align-items-center justify-content-between" id="'.$prefix.'_response-'.$muro_id.'">
                    ...
                    <form class="mt-3" method="POST">
                        <div class="form-group">
                            <textarea class="form-control" id="'.$prefix.'_respuesta_'.$muro_id.'" name="'.$prefix.'_respuesta_'.$muro_id.'" rows="5" maxlength="500" placeholder="'.$this->get('translator')->trans('Escriba su respuesta').'"></textarea>
                        </div>
