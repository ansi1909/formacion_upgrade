    ...
    public function indexAction($app_id)
    {
        ...
        foreach ($pages as $page) {
            ...
            array_push($paginas,array(
                ...
                'modificacion'=> $pagina['modificado'],
                'status'=> $pagina['estatus_contenido'],
                'delete_disabled'=> $pagina['delete_disabled'],
                'mover'=> $pagina['mover'],
                'subpaginas'=> array('tiene'=>count($array[$pagina['id']]),'return'=>$f->obtenerEstructuraArbol($array))
            ));
        }
       // return new response(var_dump($paginas));
        return $this->render('LinkBackendBundle:Pagina:index.html.twig', array('paginas' =>array_filter($paginas)));
