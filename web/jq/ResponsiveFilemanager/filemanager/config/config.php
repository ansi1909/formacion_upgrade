...
//$upload_dir = '/'.$_SESSION["ROOT_SITE"].'/web/uploads/noticias'; // path from base_url to base of upload folder (with start and final /)
...
$ext_file 	= array('xls', 'xlsx', 'csv', 'pdf'); //Files
