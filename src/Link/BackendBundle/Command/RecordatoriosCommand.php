...
class LinkRecordatoriosCommand extends ContainerAwareCommand
{
    ...
    protected function execute(InputInterface $input, OutputInterface $output)
    {
        ...
        $usuarios = $this->getDoctrine()->getRepository('LinkComunBundle:AdminUsuario')->findAll();
        ...
        foreach ($usuarios as $usuario){
           ...
           if(count($sinsession) < 1){
               ...
               foreach ($programadas as $prog){
                    ...
                    $notificacion = $this->getDoctrine()->getRepository('LinkComunBundle:AdminNotificacion')->find($prog->getNotificacion()->getId());
        ...
        foreach ($usuarios as $usuario){
            ...
            $programas_disponibles = $this->getDoctrine()->getRepository('LinkComunBundle:CertiNivelPagina')->findbyNivel($usuario->getNivel()->getId());
