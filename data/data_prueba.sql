...
SELECT pg_catalog.setval('admin_permiso_id_seq', 78, false);
...
INSERT INTO certi_pagina VALUES (12, 'Pensamiento estratégico', NULL, 7, '<p>Proyecta tus objetivos desde un punto de partida m&aacute;s acertado, aplicando la estrategia de negocios m&aacute;s conveniente.</p>', '<p><strong><em>El pensamiento estrat&eacute;gico</em></strong>&nbsp;es entender y conectar el trabajo cotidiano con la estrategia del negocio. Es por ello que todo pensador estrat&eacute;gico sabe a d&oacute;nde quiere llegar, d&oacute;nde se encuentra ubicado, hacia d&oacute;nde quiere ir y est&aacute; en la capacidad de corregir la direcci&oacute;n de la empresa si esto fuese necesario creando estrategias competitivas e innovadoras.</p>
...
INSERT INTO certi_pagina VALUES (83, 'Creatividad', NULL, 7, '<p>Dise&ntilde;a propuestas competitivas y &ldquo;fuera de la caja&rdquo;, con este curso en l&iacute;nea aprender&aacute;s a conceptualizar estrategias innovadoras.</p>', '<p><img alt="" src="https://www.formacion2puntocero.com/admin/web/ckfinder/userfiles/images/AG_C_Bienvenida.jpg" style="width:820px" /></p>
