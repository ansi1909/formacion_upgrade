...
class ProgramaController extends Controller
{
    ...
    public function programaAction($programa_id, Request $request)
    {
        ...
        $texto_bienvenida = $this->get('translator')->trans('Bienvenido '.trim($categoria->getBienvenida().' '.strtolower(trim($categoria->getNombre()))));
        $titulo_tarjetas = $this->get('translator')->trans(trim($categoria->getTarjetas()));
        $texto_progreso = $this->get('translator')->trans('Tu progreso en '.trim($categoria->getPronombre()).' '.strtolower(trim($categoria->getNombre())));
