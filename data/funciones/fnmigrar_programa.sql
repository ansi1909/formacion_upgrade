CREATE OR REPLACE FUNCTION  fnmigrar_programa(ppagina_id integer,pconexion text) RETURNS VOID AS $$
DECLARE
...
DECLARE
BEGIN
   PERFORM dblink_connect('migrar_programa',pconexion);
...
END
$$ LANGUAGE plpgsql;
--SELECT * from fnmigrar_programa(109,'host=atenas.venred.com user=smrtfrmc_smart password=oIAk4%@o)MdD dbname=smrtfrmc_formacion');
